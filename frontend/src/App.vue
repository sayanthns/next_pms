    ...
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        <div class="nav-section">
          ...
          <router-link v-if="!settingsStore.isCustomer" to="/weekly-plan" class="nav-link" :class="{ active: isActive('/weekly-plan') }">
            <span class="nav-icon">
            ...
            <span v-show="!isDesktopCollapsed" class="nav-label">Weekly Plan</span>
          </router-link>
          <router-link v-if="!settingsStore.isCustomer" to="/calendar" class="nav-link" :class="{ active: isActive('/calendar') }">
            <span class="nav-icon">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/><line x1="8" y1="14" x2="8" y2="14"/><line x1="12" y1="14" x2="12" y2="14"/><line x1="16" y1="14" x2="16" y2="14"/><line x1="8" y1="18" x2="8" y2="18"/><line x1="12" y1="18" x2="12" y2="18"/></svg>
            </span>
            <span v-show="!isDesktopCollapsed" class="nav-label">Calendar</span>
          </router-link>
          ...
          <router-link v-if="settingsStore.isAdmin || settingsStore.isManager" to="/support-tickets" class="nav-link" :class="{ active: isActive('/support-tickets') }">
            <span class="nav-icon">
            ...
            <span v-show="!isDesktopCollapsed" class="nav-label">Support Tickets</span>
          </router-link>
          <router-link v-if="settingsStore.isAdmin || settingsStore.isManager" to="/portal-analytics" class="nav-link" :class="{ active: isActive('/portal-analytics') }">
            <span class="nav-icon">
            ...
            <span v-show="!isDesktopCollapsed" class="nav-label">Client Portal</span>
          </router-link>
    ...
    <Transition name="sheet">
      <div v-if="showMoreSheet" class="more-sheet">
        ...
        <div class="more-sheet-content">
          ...
          <router-link v-if="!settingsStore.isCustomer" to="/calendar" class="more-sheet-item" :class="{ active: isActive('/calendar') }" @click="showMoreSheet = false">
